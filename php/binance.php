    ...
    public function _websocket_handle_ob ($contextId, $data) {
        ...
        if (!(is_array ($symbolData) && array_key_exists ('ob', $symbolData))) {
            ...
            if ($partsLen > 50) {
                ...
                if (!(is_array ($data) && array_key_exists ('snaplaunched', $data))) {
                    $data['snaplaunched'] = true;
                    $this->_executeAndCallback ($this->_websocketMethodMap ('fetchOrderBook'), [$symbol], $this->_websocketMethodMap ('_websocketHandleObRestSnapshot'), array (
                        'symbol' => $symbol,
                        'contextId' => $contextId,
                    ));
                }
            ...
            $symbolData['ob'] = $this->mergeOrderBookDelta ($symbolData['ob'], $data, null, 'b', 'a');
